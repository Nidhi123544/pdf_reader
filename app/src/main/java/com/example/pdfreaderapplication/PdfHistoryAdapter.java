...
public class PdfHistoryAdapter extends ArrayAdapter<HistoryMarkEntity> {
    Context context;
    ArrayList<HistoryMarkEntity> all_pdf;
    ViewHolder holder=new ViewHolder();
    public PdfHistoryAdapter(Context context, ArrayList<HistoryMarkEntity> all_pdf) {
        super(context, R.layout.adapter_history_pdf, all_pdf);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ViewHolder holder=new ViewHolder();
        if (view == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.adapter_history_pdf, parent, false);
        }
        Database db=new Database(context);
        holder.textView =(TextView)view.findViewById(R.id.tv_history_name);
       ...
       // holder.deleteImageView=(ImageView)view.findViewById(R.id.historydeleteImage);
       // holder.checkBox=(CheckBox)view.findViewById(R.id.historycheckbox);
